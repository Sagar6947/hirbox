                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <div class="text-center">
                                        <h5 class="mb-0">Login as Recruiter</h5>
                                       
                                    </div>
                                    
                                    <form class="mt-4 pt-2" action="<?= base_url('recruiter-dashboard') ?>" method="POST">
                                        <div class="form-floating form-floating-custom mb-4">
                                            <input type="text" class="form-control" id="input-username" placeholder="Enter User Name" value="9039005753">
                                        ...
                                        <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                                            <input type="password" class="form-control pe-5" id="password-input" placeholder="Enter Password" value="12345">
